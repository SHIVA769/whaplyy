...
export const ResetPassword = () => {
  ...
  return (
    <div>
      ...
      <p className="text-xs text-slate-400 mb-6">Choose a strong password to secure your workspace</p>
      ...
      {success ? (
        <div className="text-center py-4 space-y-4">
          ...
          <p className="text-xs text-slate-400">You can now log in using your updated password.</p>
          <Link
            to="/login"
            className="inline-flex items-center justify-center w-full py-2.5 px-4 bg-primary-600 hover:bg-primary-700 text-white font-bold rounded-xl text-sm shadow-md transition-all mt-2"
          >
